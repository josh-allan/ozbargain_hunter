...
interesting_searches = ['Samsung', 'Credit Card', 'Sony', 'RTX', 'M.2', 'NVME', 'OLED', 'SSD', 'LG', 'Pixel', 'Monitor', '27']
...
while True:
    ...
    if matching_entries:
        for entry in matching_entries:
            print(f"Matching entry found in {feed[0]}: {entry.title} at {now.strftime('%d/%m/%Y, %H:%M:%S')}")
